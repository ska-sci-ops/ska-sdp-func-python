...
project = "SKA SDP Python Processing Functions"
...
html_context = {
    ...
    "github_repo": "ska-sdp-func-pyton",  # Repo name
...
htmlhelp_basename = "ska-sdp-func-python-doc"
...
latex_documents = [
    (
        master_doc,
        "src.tex",
        "SKA SDP Python Processing Functions Documentation",
        author,
        "manual",
    ),
]
